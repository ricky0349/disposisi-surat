...
<td>
<div>
<a href=".base_url('admin/user/getedit/' . $u
ser->id)." class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</
a>
<a href=".base_url('admin/user/delete/' . $us
er->id)." class='btn btn-sm btn-danger'
