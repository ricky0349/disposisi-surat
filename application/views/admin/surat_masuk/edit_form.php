...
<li class="breadcrumb-item"><a href="<?php echo site_url('admin/user') ?>">Surat Masuk</a></li>
...
<input class="form-control" type="hidden" name="old_image" value="<?php echo $surat->image;?>" required />
</div>
